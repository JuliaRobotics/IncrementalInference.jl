...
function getCurrentWorkspaceFactors()
    return [
        subtypes(IncrementalInference.AbstractPrior)...,
        subtypes(IncrementalInference.AbstractRelativeFactor)...,
        subtypes(IncrementalInference.AbstractRelativeFactorMinimize)...];
end
