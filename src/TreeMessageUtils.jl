...
"""
function setUpMsgThis!(cliql::TreeClique, msgs::LikelihoodMessage)
...
"""
getUpMsgsThis(cliql::TreeClique) = getCliqueData(cliql).upMsg
getUpMsgsThis(btl::AbstractBayesTree, frontal::Symbol) = getUpMsgs(getClique(btl, frontal))
