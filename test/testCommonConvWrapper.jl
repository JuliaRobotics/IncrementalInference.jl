...
function (tt::Test2)(res::Vector{<:Real}, userdata::FactorMetadata, idx::Int, meas::Tuple{Array{<:Real,2}}, tp1::Array{<:Real,2}, tp2::Array{<:Real,2})
  tp1[1,1]=-2.0;
  res[:] .= 1.0
  nothing;
end
...
function (Dp::Pose1Pose1Test)(res::Array{<:Real},
