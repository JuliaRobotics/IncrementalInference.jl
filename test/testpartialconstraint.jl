...
mutable struct DevelopPartial <: IncrementalInference.AbstractPrior
  x::Distribution
...
mutable struct DevelopDim2 <: IncrementalInference.AbstractPrior
  x::Distribution
end
...
mutable struct DevelopPartialPairwise <: IncrementalInference.AbstractRelativeFactor
  x::Distribution
  partial::Tuple
