...
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x0))[1,:] ) < 1.6
...
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x0))[1,:] ) < 1.6
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x1))[1,:] ) < 1.6
...
@test abs((getKDE(fg, :x0) |> getKDEMean)[1] + 1) < 0.6
@test abs((getKDE(fg, :x1) |> getKDEMean)[1]) < 0.6
@test abs((getKDE(fg, :x2) |> getKDEMean)[1] - 1) < 0.6

@test 0.4 < Statistics.cov( getPoints(getKDE(fg, :x0))[1,:] ) < 1.6
@test 0.4 < Statistics.cov( getPoints(getKDE(fg, :x1))[1,:] ) < 1.6
@test 0.4 < Statistics.cov( getPoints(getKDE(fg, :x2))[1,:] ) < 1.6
...
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x0))[1,:] ) < 1.6
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x1))[1,:] ) < 1.6
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x2))[1,:] ) < 1.6
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x3))[1,:] ) < 1.6
@test 0.5 < Statistics.cov( getPoints(getKDE(fg, :x4))[1,:] ) < 1.6
