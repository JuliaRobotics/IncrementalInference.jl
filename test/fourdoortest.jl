...
addFactor!(fg,[v2;v3],Odo([50.0]',[4.0]',[1.0])) #, samplefnc=getSample
f2 = addFactor!(fg,[v3], Obsv2(doors2, bws', [1.0]))

v4=addNode!(fg,:x4,2.0*randn(1,N)+getVal(v3)+50.0, N=N)
addFactor!(fg,[v3;v4],Odo([50.0]',[2.0]',[1.0])) #, samplefnc=getSample
...
addFactor!(fg,[v4;v5],Odo([50.0]',[2.0]',[1.0])) #, samplefnc=getSample


v6=addNode!(fg,:x6,1.25*randn(1,N)+getVal(v5)+40.0, N=N)
addFactor!(fg,[v5;v6],Odo([40.0]',[1.25]',[1.0])) #, samplefnc=getSample


v7=addNode!(fg,:x7,2.0*randn(1,N)+getVal(v6) +60.0, N=N)
addFactor!(fg,[v6;v7],Odo([60.0]',[2.0]',[1.0])) #, samplefnc=getSample

f3 = addFactor!(fg,[v7], Obsv2(doors, bws', [1.0])) #, samplefnc=getSample
