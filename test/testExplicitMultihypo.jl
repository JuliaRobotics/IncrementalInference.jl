...
# sfidx=1, mhidx=1:  ah = []     pidx = 1
# sfidx=1, mhidx=2:  ah = [1;2]  pidx = 2
# sfidx=1, mhidx=3:  ah = [1;3]  pidx = 3
s3_1_gt1 = [1]
s3_1_gt2 = (0,4,4,20)
...
# sfidx=2, mhidx=1: p=2?   ah = [2;3]?
# sfidx=2, mhidx=2: p=1   ah = [1;2]
# sfidx=2, mhidx=3: p=3   [2;3], 2 should take a value from 3
s3_2_gt1 = [1]
s3_2_gt2 = (0,4,4,20)
...
# sfidx=3, mhidx=1: p=3?  ah = #[2;3]
# sfidx=3, mhidx=2: p=2  [2:3], 3 should take a value from 2
# sfidx=3, mhidx=3: p=1  ah = [1;3]
s3_3_gt1 = [1]
s3_3_gt2 = (0,4,4,20)
...
s4_1 = IncrementalInference.assembleHypothesesElements!(Categorical([0.0;0.3;0.3;0.4]), N, 1, 4 )
